...
class Aluno(AbstractUser):
    ...
    matricula = models.IntegerField(verbose_name='Matrícula', unique=True, blank=True, null=True)
    seduc = models.CharField(verbose_name='Senha Seduc', max_length=255, blank=True, null=True)
    cpf = models.IntegerField(verbose_name='CPF', unique=True, blank=True, null=True)
    serie = models.IntegerField(verbose_name='Série do aluno', choices=SERIES_CHOICES, blank=True, null=True)
